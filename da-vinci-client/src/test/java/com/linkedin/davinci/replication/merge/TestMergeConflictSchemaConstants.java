...
class TestMergeConflictSchemaConstants {
  ...
  static final String USER_SCHEMA_STR_V4 = "{" + "  \"namespace\" : \"example.avro\",  " + "  \"type\": \"record\",   "
      + "  \"name\": \"User\",     " + "  \"fields\": [           "
      + "       { \"name\": \"name\", \"type\": \"string\", \"default\": \"venice\"},  "
  ...
  static final String PERSON_SCHEMA_STR_V1 = "{" + "  \"name\": \"Person\"," + "  \"type\": \"record\","
  ...
  // Person V2 schema mismatches with person V1 schema in a way that it has two additional fields "favoritePet" and
  // "stringArray"
  // and it drops the "stringMap" field.
  static final String PERSON_SCHEMA_STR_V2 = "{" + "  \"name\": \"Person\"," + "  \"type\": \"record\","
      + "  \"fields\": [" + "       { \"name\": \"age\", \"type\": \"int\", \"default\": -1},  "
  ...
  static final String PERSON_SCHEMA_STR_V3 = "{" + "  \"name\": \"Person\"," + "  \"type\": \"record\","
      + "  \"fields\": [" + "       { \"name\": \"age\", \"type\": \"int\", \"default\": -1},  "
      + "       { \"name\": \"favoritePet\", \"type\": \"string\", \"default\": \"Pancake!\"},  "
      + "       { \"name\": \"name\", \"type\": \"string\", \"default\": \"default_name\"},  "
      + "       { \"name\": \"intArray\", \"type\": {\"type\": \"array\", \"items\": \"int\"}, \"default\": [] }, "
