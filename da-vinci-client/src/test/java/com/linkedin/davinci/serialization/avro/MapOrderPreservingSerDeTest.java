...
public class MapOrderPreservingSerDeTest {
  ...
  private void validateConsistentSerdeResults(
    ...
    for (int i = 0; i < totalShuffleCount; i++) {
      ...
      IndexedHashMap<Utf8, Integer> deserializedMap = (IndexedHashMap<Utf8, Integer>) deserializedRecord.get("PetNameToAge");
      ...
      List<String> deserializedListEntries = ((List<Utf8>) deserializedRecord.get("Items"))
          .stream()
          .map(Utf8::toString)
