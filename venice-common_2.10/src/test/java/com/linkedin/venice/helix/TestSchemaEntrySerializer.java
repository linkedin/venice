...
public class TestSchemaEntrySerializer {
  ...
  public void testSerialize() throws IOException {
    ...
    String expected = "{\"type\":\"record\",\"name\":\"User\",\"namespace\":\"example.avro\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"kind\",\"type\":{\"type\":\"enum\",\"name\":\"Kind\",\"symbols\":[\"ONE\",\"TWO\",\"THREE\"]}}]}";
    Assert.assertEquals(new String(serializer.serialize(entry, "/test_store/value_schema/1")), expected);
  }

  @Test
  public void testDeserialize() throws IOException {
    String schemaStr = "{\"type\":\"record\",\"name\":\"User\",\"namespace\":\"example.avro\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"kind\",\"type\":{\"type\":\"enum\",\"name\":\"Kind\",\"symbols\":[\"ONE\",\"TWO\",\"THREE\"]}}]}";
