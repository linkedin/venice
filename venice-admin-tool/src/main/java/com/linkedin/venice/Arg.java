...
public enum Arg {
  ...
  AUTO_SUPERSET_SCHEMA_REGISTER_FOR_READ_COMPUTE_STORE_ENABLED("auto-superset-schema-register-for-read-compute-store-enabled", "asa", true, "whether or not auto super-set register enabled for a read compute store"),
