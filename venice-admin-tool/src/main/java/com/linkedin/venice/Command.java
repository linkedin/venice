...
public enum Command {
  ...
  UPDATE_STORE("update-store","update store metadata",
      new Arg[] {URL, CLUSTER, STORE},
      new Arg[] {OWNER, VERSION, LARGEST_USED_VERSION_NUMBER, PARTITION_COUNT, PARTITIONER_CLASS, PARTITIONER_PARAMS, AMPLIFICATION_FACTOR,
          READABILITY, WRITEABILITY, STORAGE_QUOTA, HYBRID_STORE_OVERHEAD_BYPASS,
          READ_QUOTA, HYBRID_REWIND_SECONDS, HYBRID_OFFSET_LAG, HYBRID_TIME_LAG, HYBRID_DATA_REPLICATION_POLICY, ACCESS_CONTROL, COMPRESSION_STRATEGY,
          CLIENT_DECOMPRESSION_ENABLED, CHUNKING_ENABLED, BATCH_GET_LIMIT, NUM_VERSIONS_TO_PRESERVE,
          ...
          INCREMENTAL_PUSH_POLICY, BACKUP_VERSION_RETENTION_MS, REPLICATION_FACTOR, NATIVE_REPLICATION_SOURCE_FABRIC, REPLICATE_ALL_CONFIGS,
          ACTIVE_ACTIVE_REPLICATION_ENABLED, REGIONS_FILTER}),
