...
public enum Command {
  ...
  UPDATE_STORE("update-store","update store metadata",
      new Arg[] {URL, CLUSTER, STORE},
      new Arg[] {OWNER, VERSION, LARGEST_USED_VERSION_NUMBER, PARTITION_COUNT, READABILITY, WRITEABILITY, STORAGE_QUOTA, HYBRID_STORE_OVERHEAD_BYPASS,
          ...
          AUTO_SUPERSET_SCHEMA_FOR_READ_COMPUTE_STORE_ENABLED, INCREMENTAL_PUSH_ENABLED, BOOTSTRAP_TO_ONLINE_TIMEOUT_IN_HOUR}),
