...
public enum Command {
  ...
  UPDATE_STORE("update-store","update store metadata",
      ...
      new Arg[] {OWNER, VERSION, LARGEST_USED_VERSION_NUMBER, PARTITION_COUNT, READABILITY, WRITEABILITY, STORAGE_QUOTA,
          READ_QUOTA, HYBRID_REWIND_SECONDS, HYBRID_OFFSET_LAG, ACCESS_CONTROL, COMPRESSION_STRATEGY, CHUNKING_ENABLED,
          SINGLE_GET_ROUTER_CACHE_ENABLED, BATCH_GET_ROUTER_CACHE_ENABLED, BATCH_GET_LIMIT, NUM_VERSIONS_TO_PRESERVE,
          WRITE_COMPUTATION_ENABLED, READ_COMPUTATION_ENABLED, LEADER_FOLLOWER_MODEL_ENABLED}),
