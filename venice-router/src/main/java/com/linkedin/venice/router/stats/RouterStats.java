...
public class RouterStats<STAT_TYPE> {
  ...
  public STAT_TYPE getStatsByType(RequestType requestType) {
    switch (requestType) {
      case SINGLE_GET: return statsForSingleGet;
      case MULTI_GET: return statsForMultiGet;
      case COMPUTE: return statsForCompute;
      case MULTI_GET_STREAMING: return statsForMultiGetStreaming;
      case COMPUTE_STREAMING: return statsForComputeStreaming;
      default: throw new VeniceException("Unknown request type: " + requestType);
    }
  }
