...
public class ReadsRequestThrottlerTest {
  ...
  private ReadsRequestThrottler throttler;
  ...
  public void setup() {
    ...
    throttler = new ReadsRequestThrottler(zkRoutersClusterManager, storeRepository);
  }
  ...
  public void testGetQuotaForStore() {
    ...
    Assert.assertEquals(throttler.getQuotaForStore(store.getName()),
        ReadsRequestThrottler.DEFAULT_STORE_READ_QUOTA / routerCount);
  }
