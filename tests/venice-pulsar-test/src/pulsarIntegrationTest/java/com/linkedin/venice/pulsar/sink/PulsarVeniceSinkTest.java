...
public class PulsarVeniceSinkTest {
  ...
  // Apache Kafka pub-sub adapter factory classes passed to admin-tool JVM invocations run inside the
  // venice-client container. The admin tool fails fast when these are not provided (no implicit default).
  private static final String PUBSUB_ADAPTER_FACTORY_JVM_ARGS = "-Dpubsub.producer.adapter.factory.class="
      + "com.linkedin.venice.pubsub.adapter.kafka.producer.ApacheKafkaProducerAdapterFactory "
      + "-Dpubsub.consumer.adapter.factory.class="
      + "com.linkedin.venice.pubsub.adapter.kafka.consumer.ApacheKafkaConsumerAdapterFactory "
      + "-Dpubsub.admin.adapter.factory.class="
  ...
  public void testPulsarVeniceSink() throws Exception {
    ...
    String readinessCmd = "java " + PUBSUB_ADAPTER_FACTORY_JVM_ARGS + " -jar " + jar + " --describe-store --url "
  ...
  private void initVeniceStore(String veniceControllerUrl, String jar, String clusterName, String storeName)
    ...
    execByServiceAsssertNoStdErr(
        ...
        "bash",
        "-c",
        "java " + PUBSUB_ADAPTER_FACTORY_JVM_ARGS + " -jar " + jar + " --empty-push --url " + veniceControllerUrl
            + " --cluster " + clusterName + " --store " + storeName + " --push-id init --store-size 1000");
  }
  ...
  private void updateVeniceStoreQuotas(String veniceControllerUrl, String jar, String clusterName, String storeName)
    ...
    execByServiceAsssertNoStdErr(
        ...
        "bash",
        "-c",
        "java " + PUBSUB_ADAPTER_FACTORY_JVM_ARGS + " -jar " + jar + " --update-store --url " + veniceControllerUrl
            + " --cluster " + clusterName + " --store " + storeName
    ...
    execByServiceAsssertNoStdErr(
        ...
        "-c",
        "java " + PUBSUB_ADAPTER_FACTORY_JVM_ARGS + " -jar " + jar + " --update-store --url " + veniceControllerUrl
            + " --cluster " + clusterName + " --store " + storeName + " --read-quota 1000000");
  }
  ...
  private void createVeniceStore(
    ...
    execByServiceAsssertNoStdErr(
        ...
        "bash",
        "-c",
        "java " + PUBSUB_ADAPTER_FACTORY_JVM_ARGS + " -jar " + jar + " --new-store --url " + veniceControllerUrl
            + " --cluster " + clusterName + " --store " + storeName + " --key-schema-file " + keyFile
            + " --value-schema-file " + valueFile);
  }
