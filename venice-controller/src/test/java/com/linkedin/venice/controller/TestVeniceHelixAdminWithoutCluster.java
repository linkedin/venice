...
public class TestVeniceHelixAdminWithoutCluster {
  ...
  public void canMergeNewHybridConfigValuesToOldStore() {
    ...
    HybridStoreConfig hybridStoreConfig = VeniceHelixAdmin.mergeNewSettingsIntoOldHybridStoreConfig(store,
    ...
    hybridStoreConfig = VeniceHelixAdmin.mergeNewSettingsIntoOldHybridStoreConfig(store, rewind, lagOffset, timeLag,
        dataReplicationPolicy, bufferReplayPolicy);
  ...
  private void testCheckResourceCleanupBeforeStoreCreationWithParams(String clusterName,
      String storeName, Optional<StoreConfig> storeConfig, Optional<Store> store, Set<String> topics,
      List<String> helixResources, Consumer<VeniceHelixAdmin> testExecution) {
