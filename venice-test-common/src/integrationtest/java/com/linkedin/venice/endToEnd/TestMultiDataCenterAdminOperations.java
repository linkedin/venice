...
public class TestMultiDataCenterAdminOperations {
  ...
  public void testHybridConfigPartitionerConfigConflict() {
    ...
    ControllerResponse
        response = controllerClient.updateStore(storeName, new UpdateStoreQueryParams().setHybridRewindSeconds(259200).setHybridOffsetLagThreshold(1000));
  ...
  public void testFailedAdminMessages() {
    ...
    VeniceWriter<byte[], byte[], byte[]> veniceWriter = veniceWriterFactory.createBasicVeniceWriter(AdminTopicUtils.getTopicNameFromClusterName(clusterName));
