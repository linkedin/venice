...
public enum StatsErrorCode {
   ...
   * {@link com.linkedin.venice.kafka.consumer.StoreIngestionService} has identified
  ...
  /**
   * Inactive {@link com.linkedin.venice.kafka.consumer.StoreIngestionTask} instances
