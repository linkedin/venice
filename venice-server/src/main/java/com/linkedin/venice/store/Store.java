...
public interface Store {
     ...
     */
    public byte[] get(byte[] key) throws VeniceStorageException;
     ...
     * @throws VeniceStorageException
     */
    public void put(byte[] key, byte[] value) throws VeniceStorageException;
     ...
     * @throws VeniceStorageException
     */
    public void delete(byte[] key) throws VeniceStorageException;
