...
public class TestPushStatusStoreUtils {
  ...
  public void testGetPushKey_ServerIncrementalPushKey() {
    ...
    PushStatusKey pushStatusKey = PushStatusStoreUtils.getPushKey(42, 2, Optional.of("IP01"), Optional.of("VENICE_SERVER"));
    Assert.assertEquals(pushStatusKey.messageType, PushStatusStoreUtils.PushStatusKeyType.SERVER_INCREMENTAL_PUSH.ordinal());
    Assert.assertEquals(pushStatusKey.keyStrings, expectedKeyStrings);
  }
}