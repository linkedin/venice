...
public class TestPartition {
  ...
  public void testGetInstances() {
    ...
    Assert.assertEquals(p.getInstancesInState(HelixState.ONLINE_STATE).size(),
    ...
    Assert.assertEquals(p.getInstancesInState(HelixState.BOOTSTRAP_STATE).size(),
    ...
    Assert.assertEquals(p.getInstancesInState(HelixState.ERROR_STATE).size(),
    ...
    Assert.assertEquals(p.getBootstrapAndReadyToServeInstances().size(),
        stateToInstancesMap.get(HelixState.ONLINE_STATE).size() + stateToInstancesMap.get(HelixState.BOOTSTRAP_STATE)
            .size());
  }
