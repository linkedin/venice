...
public class TestKafkaAdminWrapperStats {
  ...
  public void testSingleton() {
    ...
    Assert.assertEquals(KafkaAdminWrapperStats.getInstance(repo1, prefix1), statsForRepo1AndPrefix1,
    ...
    Assert.assertNotEquals(KafkaAdminWrapperStats.getInstance(repo1, prefix2), statsForRepo1AndPrefix1,
    ...
    Assert.assertNotEquals(KafkaAdminWrapperStats.getInstance(repo2, prefix1), statsForRepo1AndPrefix1,
    ...
    Assert.assertNotEquals(KafkaAdminWrapperStats.getInstance(repo2, prefix2), statsForRepo1AndPrefix1,
