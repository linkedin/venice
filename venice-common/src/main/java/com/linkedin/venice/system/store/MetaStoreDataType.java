...
public enum MetaStoreDataType {
  ...
  STORE_KEY_SCHEMAS(1, Arrays.asList(KEY_STRING_STORE_NAME, KEY_STRING_CLUSTER_NAME)),
  STORE_VALUE_SCHEMAS(2, Arrays.asList(KEY_STRING_STORE_NAME, KEY_STRING_CLUSTER_NAME)),
