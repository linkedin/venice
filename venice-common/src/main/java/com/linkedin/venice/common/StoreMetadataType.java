...
public enum StoreMetadataType {
  ...
  public Object getNewInstance() {
    switch (valueOf(value)) {
      case STORE_ATTRIBUTES: return new StoreAttributes();
      case TARGET_VERSION_STATES: return new TargetVersionStates();
      case CURRENT_STORE_STATES: return new CurrentStoreStates();
      case CURRENT_VERSION_STATES: return new CurrentVersionStates();
      case STORE_KEY_SCHEMAS: return new StoreKeySchemas();
      case STORE_VALUE_SCHEMAS: return new StoreValueSchemas();
