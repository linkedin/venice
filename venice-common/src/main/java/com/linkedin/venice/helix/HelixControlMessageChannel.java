...
public class HelixControlMessageChannel implements ControlMessageChannel {
  ...
  protected <T extends ControlMessage> T convertHelixMessageToVeniceMessage(Message helixMessage) {
    try {
      ...
      T veniceMessage = clazz.newInstance();
      veniceMessage.buildFromFields(helixMessage.getRecord().getMapField(VENICE_MESSAGE_FIELD));
      ...
      throw new VeniceException("Can not create instance for mssage:" + helixMessage.getMsgId(), e);
    }
  }
