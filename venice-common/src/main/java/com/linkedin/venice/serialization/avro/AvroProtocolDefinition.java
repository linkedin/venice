...
public enum AvroProtocolDefinition {
   ...
   */
  ADMIN_OPERATION(62, SpecificData.get().getSchema(ByteBuffer.class), "AdminOperation"), // , AdminOperation.class),
   ...
   */
  METADATA_SYSTEM_SCHEMA_STORE(11, StoreMetaValue.class),
