...
public enum AvroProtocolDefinition {
   ...
   */
  ADMIN_OPERATION(51, SpecificData.get().getSchema(ByteBuffer.class), "AdminOperation"), // , AdminOperation.class),
   ...
   */
  METADATA_SYSTEM_SCHEMA_STORE(2, StoreMetaValue.class, "StoreMeta"),
