...
public enum AvroProtocolDefinition {
   ...
   */
  ADMIN_OPERATION(60, SpecificData.get().getSchema(ByteBuffer.class), "AdminOperation"), // , AdminOperation.class),
   ...
   */
  METADATA_SYSTEM_SCHEMA_STORE(10, StoreMetaValue.class),
