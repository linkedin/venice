...
public enum AvroProtocolDefinition {
   ...
   */
  ADMIN_OPERATION(31, SpecificData.get().getSchema(ByteBuffer.class), "AdminOperation"), // , AdminOperation.class),
