...
public enum AvroProtocolDefinition {
   ...
   */
  KAFKA_MESSAGE_ENVELOPE(23, 8, KafkaMessageEnvelope.class),
   ...
   */
  ADMIN_OPERATION(52, SpecificData.get().getSchema(ByteBuffer.class), "AdminOperation"), // , AdminOperation.class),
