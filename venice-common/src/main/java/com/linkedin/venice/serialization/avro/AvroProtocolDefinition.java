...
public enum AvroProtocolDefinition {
   ...
   */
  ADMIN_OPERATION(57, SpecificData.get().getSchema(ByteBuffer.class), "AdminOperation"), // , AdminOperation.class),
   ...
   */
  METADATA_SYSTEM_SCHEMA_STORE(6, StoreMetaValue.class, "StoreMeta"),
