...
public enum V1Post implements V1Route {
  ...
  STORE("/v1/cluster/%s/store", new String[] {CLUSTER}, new String[] {NAME, OWNER, KEY_SCHEMA, ControllerApiConstants.VALUE_SCHEMA}),
  VALUE_SCHEMA("/v1/cluster/%s/store/%s/val_schema", new String[] {CLUSTER, NAME}, new String[] {ControllerApiConstants.VALUE_SCHEMA}),
