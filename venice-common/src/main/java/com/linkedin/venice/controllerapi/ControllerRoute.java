...
public enum ControllerRoute {
  ...
  UPDATE_STORE("/update_store", HttpMethod.POST, Collections.singletonList(NAME), OWNER, VERSION, LARGEST_USED_VERSION_NUMBER,
      ...
      REGULAR_VERSION_ETL_ENABLED, FUTURE_VERSION_ETL_ENABLED, ETLED_PROXY_USER_ACCOUNT, INCREMENTAL_PUSH_POLICY, META_SYSTEM_STORE_ENABLED),
  ...
  GET_STALE_STORES_IN_CLUSTER("/get_stale_stores_in_cluster", HttpMethod.GET, Collections.singletonList(CLUSTER), REGIONS_FILTER),
