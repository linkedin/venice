...
public enum ControllerRoute {
  ...
  UPDATE_STORE("/update_store", HttpMethod.POST, Collections.singletonList(NAME), OWNER, VERSION, LARGEST_USED_VERSION_NUMBER,
      ...
      INCREMENTAL_PUSH_POLICY, DISABLE_META_STORE, DISABLE_DAVINCI_PUSH_STATUS_STORE),
  ...
  UPDATE_STORAGE_PERSONA("/update_storage_persona", HttpMethod.POST, Arrays.asList(CLUSTER, NAME), PERSONA_QUOTA, PERSONA_STORES, PERSONA_OWNERS);
