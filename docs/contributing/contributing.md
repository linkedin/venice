...
[Venice Improvement Proposal](documentation/design-docs.md) 
...
This project and everyone who participates in it is governed by the [Venice Code of Conduct](code-of-conduct.md). By participating, you are expected to uphold this code. Please report unacceptable behavior on [Slack](https://venicedb.slack.com/archives/C03SLQWRSLF).