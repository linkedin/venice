...
public class TestAvroSchemaUtils {
  ...
  public void testSchemaUnionDefaultValidation() {
    ...
    Assert.assertTrue(AvroSchemaUtils.isValidAvroSchema(AvroSchemaParseUtils.parseSchemaFromJSONStrictValidation(schemaStr)));
    ...
    try {
      Assert.assertFalse(AvroSchemaUtils.isValidAvroSchema(AvroSchemaParseUtils.parseSchemaFromJSONStrictValidation(schemaStr)));
      AvroSchemaUtils.validateAvroSchemaStr(schemaStr);
