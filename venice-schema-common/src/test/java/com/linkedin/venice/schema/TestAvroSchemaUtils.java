...
public class TestAvroSchemaUtils {
  ...
  public void testWithDifferentDocField() {
    String schemaStr1 = "{\"type\":\"record\",\"name\":\"KeyRecord\",\"fields\":[{\"name\":\"name\",\"type\":\"string\", \"default\": \"default_name\", \"doc\":\"name field\"},{\"name\":\"company\",\"type\":\"string\", \"default\": \"default_company_name\"}]}";
    String schemaStr2 = "{\"type\":\"record\",\"name\":\"KeyRecord\",\"fields\":[{\"name\":\"name\",\"type\":\"string\", \"default\": \"default_name\",\"doc\":\"name field\"},{\"name\":\"company\",\"type\":\"string\", \"doc\": \"company name here\", \"default\": \"default_company_name\"}]}";
  ...
  public void testStringVsAvroString() {
    ...
    Schema s3 = AvroSchemaUtils.generateSupersetSchemaHelper(s2, s1);
    Assert.assertNotNull(s3);
  ...
  public void testSchemaMerge() {
    ...
    Schema s2 = AvroSchemaParseUtils.parseSchemaFromJSONStrictValidation(schemaStr2);
    Assert.assertFalse(AvroSchemaUtils.compareSchemaIgnoreFieldOrder(s1,s2));
    Schema s3 = AvroSchemaUtils.generateSupersetSchemaHelper(s1, s2);
    Assert.assertNotNull(s3);
  }
  ...
  public void testSchemaUnionDefaultValidation() {
    ...
    AvroSchemaVerifier.get().verifyCompatibility(
  ...
  public void tesMergeWithDefaultValueUpdate() {
    String schemaStr1 = "{\n" +
        ...
        "           \"name\": \"KeyRecord\",\n" +
        "           \"fields\" : [\n" +
        "               {\"name\": \"name\", \"type\": \"string\", \"doc\": \"name field\", \"default\":\"default_name\"},\n" +
        "               {\"name\": \"company\", \"type\": \"string\", \"default\":\"default_company_name\"},\n" +
        "               {\n" +
        "                 \"name\": \"Suit\", \n" +
        "                 \"type\": {\n" +
        "                        \"name\": \"SuitType\", \"type\": \"enum\", \"symbols\": [\"SPADES\", \"DIAMONDS\", \"HEART\", \"CLUBS\"]\n" +
    ...
    String schemaStr2 = "{\n" +
        ...
        "           \"name\": \"KeyRecord\",\n" +
        "           \"fields\" : [\n" +
        "               {\"name\": \"name\", \"type\": \"string\", \"default\":\"default_name\", \"doc\": \"name field\"},\n" +
        "               {\"name\": \"company\", \"type\": \"string\", \"default\":\"default_company_name\"},\n" +
        "               {\n" +
        "                 \"name\": \"Suit\", \n" +
        "                 \"type\": {\n" +
