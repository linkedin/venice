...
public class RetryUtilsTest {
    ...
    public void testFixedDelayRetryOnRunnable() throws CustomizedCheckedException {
        ...
        // Case 1: no failure
        RetryUtils.executeWithMaxAttempt(obj::doSomething, 3, Duration.ofMillis(1), Collections.singletonList(IllegalStateException.class));
        ...
        doThrow(IllegalArgumentException.class)
                ...
                .doNothing()
                .when(obj).doSomething();

        RetryUtils.executeWithMaxAttempt(obj::doSomething,
                3, Duration.ofMillis(1), Arrays.asList(IllegalStateException.class, IllegalArgumentException.class));
        ...
        doThrow(IllegalArgumentException.class)
                .doThrow(CustomizedRuntimeException.class) // This exception should be reported since it is not handled
                .when(obj).doSomething();
        ...
        doThrow(IllegalArgumentException.class)
                .doThrow(CustomizedCheckedException.class)
                .doNothing()
                .when(obj).doSomethingMightThrowCheckedException();

        RetryUtils.executeWithMaxAttempt(obj::doSomethingMightThrowCheckedException,
                3, Duration.ofMillis(1), Arrays.asList(CustomizedCheckedException.class, IllegalArgumentException.class));
    ...
    public void testFixedDelayRetryOnSupplier() throws CustomizedCheckedException {
        ...
        Assert.assertEquals(
                (int) RetryUtils.executeWithMaxAttempt(() -> obj.getAnInteger() + 1, 3, Duration.ofMillis(1), Collections.singletonList(IllegalStateException.class)),
                2
        );
        ...
        // Case 5: Handle checked exception and eventually succeed
        when(obj.getAnIntegerMightThrowCheckedException()).thenThrow(IllegalArgumentException.class).thenThrow(CustomizedCheckedException.class).thenReturn(1);
