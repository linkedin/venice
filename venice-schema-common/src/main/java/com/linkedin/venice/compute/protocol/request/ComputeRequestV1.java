...
public class ComputeRequestV1 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = org.apache.avro.Schema.parse("{\"type\":\"record\",\"name\":\"ComputeRequestV1\",\"namespace\":\"com.linkedin.venice.compute.protocol.request\",\"fields\":[{\"name\":\"operations\",\"type\":{\"type\":\"array\",\"items\":[{\"type\":\"record\",\"name\":\"ComputeOperation\",\"fields\":[{\"name\":\"operationType\",\"type\":\"int\",\"doc\":\"Supported operation type: 0 -> DotProduct\"},{\"name\":\"operation\",\"type\":[{\"type\":\"record\",\"name\":\"DotProduct\",\"fields\":[{\"name\":\"field\",\"type\":\"string\",\"doc\":\"The field in the original value record, which will used to execute dot-product calculation\"},{\"name\":\"dotProductParam\",\"type\":{\"type\":\"array\",\"items\":\"float\"},\"doc\":\"The passed feature vector, which will be used to execute dot-product calculation against the field in the original value record\"},{\"name\":\"resultFieldName\",\"type\":\"string\",\"doc\":\"The field name used to store the calculated result\"}]}]}]}]}},{\"name\":\"resultSchemaStr\",\"type\":\"string\",\"doc\":\"The field contains the serialized result schema, which will be used to de-serialize the response returned by Venice\"}]}");
