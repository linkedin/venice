...
public class CachingDaVinciClientFactory implements DaVinciClientFactory, Closeable {
  ...
  public CachingDaVinciClientFactory(
      ...
      MetricsRepository metricsRepository,
      VeniceProperties backendConfig) {
    this(d2Client, clusterDiscoveryD2ServiceName, metricsRepository, backendConfig, Optional.empty(), null, null);
  }
  ...
  @Override
  public <K, V extends SpecificRecord> DaVinciClient<K, V> getSpecificAvroClientWithCustomStorageEngine(
      String storeName,
      DaVinciConfig config,
      Class<V> valueClass,
      CustomStorageEngineFactory customStorageEngineFactory) {
  ...
  @Override
  public <K, V extends SpecificRecord> DaVinciClient<K, V> getAndStartSpecificAvroClientWithCustomStorageEngine(
      String storeName,
      DaVinciConfig config,
      Class<V> valueClass,
      CustomStorageEngineFactory customStorageEngineFactory) {
