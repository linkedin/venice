...
public class AggVersionedStorageIngestionStats extends
  ...
  private static final String CONSUMED_RECORD_END_TO_END_PROCESSING_LATENCY =
  ...
  static class StorageIngestionStats {
    ...
    public StorageIngestionStats(VeniceServerConfig serverConfig) {
      ...
      consumedRecordEndToEndProcessingLatencySensor =
          localMetricRepository.sensor(CONSUMED_RECORD_END_TO_END_PROCESSING_LATENCY);
      consumedRecordEndToEndProcessingLatencySensor.add(
          CONSUMED_RECORD_END_TO_END_PROCESSING_LATENCY
              + consumedRecordEndToEndProcessingLatencyMax.getClass().getSimpleName(),
          consumedRecordEndToEndProcessingLatencyMax);
      consumedRecordEndToEndProcessingLatencySensor.add(
          CONSUMED_RECORD_END_TO_END_PROCESSING_LATENCY
              + consumedRecordEndToEndProcessingLatencyAvg.getClass().getSimpleName(),
          consumedRecordEndToEndProcessingLatencyAvg);
