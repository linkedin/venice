...
public class BlobTransferIngestionHelper {
   ...
   */
  public boolean isBlobTransferEnabledForStore(Store store, boolean isDaVinciClient) {
    if (isDaVinciClient) {
   ...
   */
  public void cancelPendingBlobTransfer(PartitionConsumptionState pcs) {
   ...
   */
  public void stopBlobTransferAndWait(int partition, int timeoutInSeconds, String replicaId) {
    if (blobTransferManager == null) {
      return;
    }
