...
public class PartitionConsumptionState {
  ...
  public String toString() {
    return new StringBuilder().append("PCS{")
        ...
        .append(", isDataRecoveryCompleted=")
        .append(isDataRecoveryCompleted)
        .append(", skipKafkaMessage=")
        .append(skipKafkaMessage)
        ...
        .append(", started=")
        .append(isStarted())
        .append(", completionReported=")
        .append(completionReported)
        .append(", lagCaughtUp=")
        .append(lagCaughtUp)
        .append(", lagCaughtUpTimeInMs=")
        .append(lagCaughtUpTimeInMs)
        .append(", readyToServeTimeLagThresholdInMs=")
        .append(readyToServeTimeLagThresholdInMs)
        .append(", hasResubscribedAfterBootstrapAsCurrentVersion=")
        .append(hasResubscribedAfterBootstrapAsCurrentVersion)
        .append(", consumptionStartTimeInMs=")
        .append(consumptionStartTimeInMs)
        .append(", startOfPushTimestamp=")
        .append(startOfPushTimestamp)
        .append(", endOfPushTimestamp=")
        .append(endOfPushTimestamp)
        .append(", latestMessageConsumedTimestampInMs=")
        .append(latestMessageConsumedTimestampInMs)
        .append(", latestPolledMessageTimestampInMs=")
        .append(latestPolledMessageTimestampInMs)
        ...
        .append(", hasTopicSwitch=")
        .append(topicSwitch != null)
        .append("}")
        .toString();
  }
