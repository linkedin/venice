...
import static com.linkedin.venice.ConfigKeys.SERVER_AA_WC_VT_COALESCING_ENABLED;
...
public class VeniceServerConfig extends VeniceClusterConfig {
  ...
  private final boolean aaWCVtCoalescingEnabled;
  ...
  public VeniceServerConfig(VeniceProperties serverProperties, Map<String, Map<String, String>> kafkaClusterMap)
    ...
    aaWCVtCoalescingEnabled = serverProperties.getBoolean(SERVER_AA_WC_VT_COALESCING_ENABLED, false);
  ...
  public boolean isAAWCVtCoalescingEnabled() {
    return aaWCVtCoalescingEnabled;
  }
