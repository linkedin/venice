...
public class PartitionReplicaIngestionContext {
  ...
  public static WorkloadType getWorkloadType(@NotNull Version version, @NotNull Store store) {
  ...
  public static VersionRole getStoreVersionRole(@NotNull Version version, @NotNull Store store) {
    checkVersionTopicStoreOrThrow(version, store);
