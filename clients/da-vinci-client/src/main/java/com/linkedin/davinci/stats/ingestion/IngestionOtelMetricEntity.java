...
public enum IngestionOtelMetricEntity implements ModuleMetricEntityInterface {
  ...
  PARTIAL_UPDATE_TIME(
      "ingestion.partial_update.time", MetricType.MIN_MAX_COUNT_SUM_AGGREGATIONS, MetricUnit.MILLISECOND,
  ...
  NEARLINE_LARGE_RECORD_BLOCKED_COUNT(
      "ingestion.partial_update.large_record_blocked_count", MetricType.COUNTER, MetricUnit.NUMBER,
