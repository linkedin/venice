 ...
 * @param <V>
 */
public class LocalBootstrappingVeniceChangelogConsumer<K, V> extends
    InternalLocalBootstrappingVeniceChangelogConsumer<K, V> implements BootstrappingVeniceChangelogConsumer<K, V> {
  public LocalBootstrappingVeniceChangelogConsumer(
      ChangelogClientConfig changelogClientConfig,
      PubSubConsumerAdapter pubSubConsumer,
      String fileSystemPath) {
    super(changelogClientConfig, pubSubConsumer, fileSystemPath);
  }
}
