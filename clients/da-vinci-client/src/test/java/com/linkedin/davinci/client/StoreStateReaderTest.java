...
/**
 * This is a clone of internal/venice-common/src/test/java/com/linkedin/venice/store/StoreStateReaderTest.java
 * It has been added to make the diff coverage gods happy :)
 */
