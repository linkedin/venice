...
public class IngestionOtelStatsTest {
  ...
  public void testRecordGlobalRtDivSent() {
    ingestionOtelStats.updateVersionInfo(CURRENT_VERSION, FUTURE_VERSION);
    ingestionOtelStats.recordGlobalRtDivSent(CURRENT_VERSION, 1024L, 3);

    // The count aggregation of send_size doubles as the number of Global RT DIV messages sent
    validateHistogramPointData(
        inMemoryMetricReader,
        1024.0,
        1024.0,
  ...
  public void testRecordGlobalRtDivVtSynced() {
    ingestionOtelStats.updateVersionInfo(CURRENT_VERSION, FUTURE_VERSION);
    ingestionOtelStats.recordGlobalRtDivVtSynced(CURRENT_VERSION, 7);
    // The count aggregation of vt_sync_producer_count doubles as the number of VT position syncs
    validateHistogramPointData(
        inMemoryMetricReader,
        7.0,
        7.0,
  ...
  public Object[][] globalRtDivErrorTypeProvider() {
    return new Object[][] { { VeniceGlobalRtDivErrorType.SEND }, { VeniceGlobalRtDivErrorType.PERSIST },
        ...
        { VeniceGlobalRtDivErrorType.LOAD } };
  }
  ...
  @Test
  public void testRecordGlobalRtDivLoaded() {
    ingestionOtelStats.updateVersionInfo(CURRENT_VERSION, FUTURE_VERSION);
    ingestionOtelStats.recordGlobalRtDivLoaded(CURRENT_VERSION, 3);
  ...
  public void testRecordGlobalRtDivLoadNotFound() {
    ingestionOtelStats.updateVersionInfo(CURRENT_VERSION, FUTURE_VERSION);
    ingestionOtelStats.recordGlobalRtDivLoadNotFound(CURRENT_VERSION);
    validateLongPointDataFromCounter(
        inMemoryMetricReader,
        1,
        buildAttributesWithVersionRoleAndSecondEnum(
