...
public class PartitionConsumptionStateTest {
  ...
  public void testUpdateChecksum() {
    PartitionConsumptionState pcs = new PartitionConsumptionState(TOPIC_PARTITION, mock(OffsetRecord.class), false);
  ...
  public void testAddIncPushVersionToPendingReportList() {
    ...
    PartitionConsumptionState pcs = new PartitionConsumptionState(TOPIC_PARTITION, offsetRecord, false);
