...
public class MaterializedViewWriterTest {
  ...
  public void testBuildWriterOptions() {
    ...
    VeniceViewWriter viewWriter = viewWriterFactory.buildStoreViewWriters(store, 1).get(viewName);
  ...
  public void testProcessControlMessage() {
    ...
    MaterializedViewWriter materializedViewWriter =
        new MaterializedViewWriter(props, version, viewParamsMap, veniceWriterFactory);
  ...
  public void testIsComplexVenicePartitioner() {
    ...
    VeniceConfigLoader props = getMockProps();
    MaterializedViewWriter materializedViewWriter =
        new MaterializedViewWriter(props, version, viewParamsBuilder.build(), veniceWriterFactory);
    ...
    MaterializedViewWriter complexMaterializedViewWriter =
        new MaterializedViewWriter(props, version, complexViewParamsBuilder.build(), veniceWriterFactory);
