...
public class HeartbeatOtelStatsTest {
  ...
  private static final int FUTURE_VERSION = 2;
  ...
  @Test
  public void testRecordHeartbeatDelayOtelMetricsForInvalidVersion() {
    heartbeatOtelStats.updateVersionInfo(CURRENT_VERSION, FUTURE_VERSION);

    // Record with NON_EXISTING_VERSION - should be ignored
    heartbeatOtelStats.recordHeartbeatDelayOtelMetrics(
    ...
    assertEquals(
        ...
        0,
        "No metrics should be recorded for invalid version");
  }
