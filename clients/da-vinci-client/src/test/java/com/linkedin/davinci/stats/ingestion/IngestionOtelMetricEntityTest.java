  ...
  private static Map<IngestionOtelMetricEntity, MetricEntityExpectation> expectedDefinitions() {
    ...
    map.put(
        ...
        new MetricEntityExpectation(
            ...
            MetricType.MIN_MAX_COUNT_SUM_AGGREGATIONS,
            MetricUnit.BYTES,
            "Byte size of each Global RT DIV payload produced to the version topic by the leader. The count aggregation doubles as the number of Global RT DIV messages sent",
            storeClusterVersion));
    map.put(
    ...
    map.put(
        ...
        new MetricEntityExpectation(
            ...
            MetricType.MIN_MAX_COUNT_SUM_AGGREGATIONS,
            MetricUnit.NUMBER,
            "Number of VT producers in the snapshot checkpointed into the OffsetRecord. The count aggregation doubles as the number of VT position syncs",
            storeClusterVersion));
    map.put(
