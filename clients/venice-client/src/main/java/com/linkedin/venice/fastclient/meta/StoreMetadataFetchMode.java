...
public enum StoreMetadataFetchMode {
   ...
   * Note: Using da-vinci-client and fast-client with {@link DA_VINCI_CLIENT_BASED_METADATA}
   * has a cyclic dependency issue, so only one of DaVinci or FC with DaVinci can be used.
   */
