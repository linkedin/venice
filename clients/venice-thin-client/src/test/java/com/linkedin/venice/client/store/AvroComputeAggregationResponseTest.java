...
public class AvroComputeAggregationResponseTest {
  ...
  private <T> void runCountByValueTest(
    ...
    AvroComputeAggregationResponse<String> response =
        new AvroComputeAggregationResponse<String>(computeResults, fieldTopKMap);
  ...
  public void testTypeCastingThrowsException() {
    ...
    AvroComputeAggregationResponse<String> response =
        new AvroComputeAggregationResponse<String>(data, Collections.singletonMap(AGE_FIELD, 10));
  ...
  public void testIntPredicateMethods() {
    ...
    AvroComputeAggregationResponse<String> response =
        new AvroComputeAggregationResponse<String>(computeResults, new HashMap<>(), fieldBucketMap);
  ...
  public void testNullValuesAndEmptyResults() {
    ...
    AvroComputeAggregationResponse<String> emptyResponse =
        new AvroComputeAggregationResponse<String>(new HashMap<>(), new HashMap<>(), fieldBucketMap);
