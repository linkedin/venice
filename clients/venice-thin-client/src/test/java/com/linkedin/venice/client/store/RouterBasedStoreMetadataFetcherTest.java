...
public class RouterBasedStoreMetadataFetcherTest {
  ...
  private TransportClient mockTransportClientWith(MultiStoreResponse response) throws Exception {
    ...
    Mockito.doReturn(mockFuture).when(mockClient).get(Mockito.eq("store_names"), Mockito.anyMap());
    return mockClient;
  }
  ...
  public void testGetAllStoreNames() throws Exception {
    ...
    Mockito.verify(mockClient, Mockito.times(1)).get(Mockito.eq("store_names"), Mockito.anyMap());
  }
  ...
  public void testGetAllStoreNamesThrowsOnTransportFailure() throws Exception {
    ...
    Mockito.doReturn(failedFuture).when(mockClient).get(Mockito.eq("store_names"), Mockito.anyMap());
