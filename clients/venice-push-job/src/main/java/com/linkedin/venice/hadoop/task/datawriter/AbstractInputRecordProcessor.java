...
public abstract class AbstractInputRecordProcessor<INPUT_KEY, INPUT_VALUE> extends AbstractDataWriterTask
  ...
  protected void configureTask(VeniceProperties props) {
     ...
     * class. TODO (ymuppala): verify whether skipping ZSTD dict setup in the Spark KIF repush path is
     * intentional — VeniceRawPubsubSource bypasses AbstractInputRecordProcessor entirely.
     *
