    ...
    TopicManagerContext topicManagerContext =
        new TopicManagerContext.Builder().setPubSubPropertiesSupplier(k -> consumerProperties)
            ...
            .setPubSubAdminAdapterFactory(
                PubSubClientsFactory.fromVeniceProperties(consumerProperties).getAdminAdapterFactory())
            .setPubSubConsumerAdapterFactory(
                PubSubClientsFactory.fromVeniceProperties(consumerProperties).getConsumerAdapterFactory())
