...
public class MRJobCounterHelper {
  ...
  private static final String COUNTER_TOTAL_ZSTD_COMPRESSED_VALUE_SIZE = "total ZSTD compressed value size";
  ...
  static final GroupAndCounterNames TOTAL_ZSTD_COMPRESSED_VALUE_SIZE_GROUP_COUNTER_NAME =
      new GroupAndCounterNames(COUNTER_GROUP_QUOTA, COUNTER_TOTAL_ZSTD_COMPRESSED_VALUE_SIZE);
  ...
  static void incrTotalZstdCompressedValueSize(Reporter reporter, long amount) {
    incrAmountWithGroupCounterName(reporter, TOTAL_ZSTD_COMPRESSED_VALUE_SIZE_GROUP_COUNTER_NAME, amount);
  }
  ...
  static long getTotalZstdCompressedValueSize(Counters counters) {
    return getCountFromCounters(counters, TOTAL_ZSTD_COMPRESSED_VALUE_SIZE_GROUP_COUNTER_NAME);
  }
