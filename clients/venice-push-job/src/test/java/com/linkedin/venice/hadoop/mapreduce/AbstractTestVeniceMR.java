...
import static com.linkedin.venice.guid.GuidUtils.DETERMINISTIC_GUID_GENERATOR_IMPLEMENTATION;
...
public class AbstractTestVeniceMR {
  ...
  protected Configuration getDefaultJobConfiguration(int partitionCount) {
    ...
    config.set(GUID_GENERATOR_IMPLEMENTATION, DETERMINISTIC_GUID_GENERATOR_IMPLEMENTATION);
