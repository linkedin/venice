...
public class CountingIteratorTest {
  ...
  private CountingIterator createCountingIterator(Iterator<Row> delegate) {
    return new CountingIterator(delegate, recordCounter, byteCounter, DEFAULT_SCHEMA, "key", "value", "rmd");
  }
  ...
  public void testEmptyIterator() {
    ...
    CountingIterator counting = new CountingIterator(
        empty,
        recordCounter,
        byteCounter,
        DEFAULT_SCHEMA,
  ...
  public void testComputeByteSizeWithSchemaIdSchema() {
    ...
    resetCounters();
    CountingIterator iter = new CountingIterator(
