...
public enum Command {
  ...
  UPDATE_STORE(
      ...
      new Arg[] { CLUSTER, OWNER, VERSION, LARGEST_USED_VERSION_NUMBER, LARGEST_USED_RT_VERSION_NUMBER, PARTITION_COUNT,
          ...
          ETL_ACTIVE_FABRICS, NATIVE_REPLICATION_ENABLED, PUSH_STREAM_SOURCE_ADDRESS, BACKUP_VERSION_RETENTION_DAY,
          REPLICATION_FACTOR, NATIVE_REPLICATION_SOURCE_FABRIC, REPLICATE_ALL_CONFIGS,
