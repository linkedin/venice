...
import static com.linkedin.venice.Arg.ENABLE_ENCRYPTION;
...
public enum Command {
  ...
  UPDATE_STORE(
      ...
      new Arg[] { CLUSTER, OWNER, VERSION, LARGEST_USED_VERSION_NUMBER, LARGEST_USED_RT_VERSION_NUMBER, PARTITION_COUNT,
          ...
          LATEST_SUPERSET_SCHEMA_ID, ENABLE_COMPACTION, COMPACTION_THRESHOLD_MILLISECONDS, ENABLE_ENCRYPTION,
