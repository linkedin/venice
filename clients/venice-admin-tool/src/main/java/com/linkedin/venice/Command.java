...
public enum Command {
  ...
  ADD_CHANGE_CAPTURE_VIEW(
      ...
      "Add change capture to a given store. This will enable all required configs including AA replication and chunking. View name argument is optional, default view name is changeCaptureView",
      new Arg[] { URL, STORE, CLUSTER }, new Arg[] { VIEW_NAME }
  );
