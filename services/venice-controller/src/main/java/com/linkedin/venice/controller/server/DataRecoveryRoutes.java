...
public class DataRecoveryRoutes extends AbstractRoute {
        ...
        new VeniceRouteHandler<ControllerResponse>(ControllerResponse.class) {
          ...
          public void internalHandle(Request request, ControllerResponse veniceResponse) {
            ...
            if (StringUtils.isEmpty(request.queryParams(AMPLIFICATION_FACTOR))) {
              ...
              sourceAmplificationFactor = Optional
                  .of(Utils.parseIntFromString(request.queryParams(AMPLIFICATION_FACTOR), AMPLIFICATION_FACTOR));
            }
  ...
  public Route isStoreVersionReadyForDataRecovery(Admin admin) {
    return new VeniceParentControllerRegionStateHandler(
        admin,
        new VeniceRouteHandler<ReadyForDataRecoveryResponse>(ReadyForDataRecoveryResponse.class) {
          @Override
