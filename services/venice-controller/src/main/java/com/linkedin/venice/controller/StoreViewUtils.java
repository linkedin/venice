...
public class StoreViewUtils {
  static String CHANGE_CAPTURE_VIEW_CLASS = "com.linkedin.venice.views.ChangeCaptureView";
  ...
  static Map<String, StoreViewConfigRecord> convertStringMapViewToStoreViewConfigRecord(Map<String, String> stringMap) {
    ...
    if (!stringMap.isEmpty()) {
      StoreViewConfigRecord newViewConfigRecord = new StoreViewConfigRecord(CHANGE_CAPTURE_VIEW_CLASS, null);
  ...
  static Map<String, StoreViewConfig> convertStringMapViewToStoreViewConfig(Map<String, String> stringMap) {
    ...
    if (!stringMap.isEmpty()) {
      StoreViewConfig newStoreViewConfig = new StoreViewConfig(CHANGE_CAPTURE_VIEW_CLASS, null);
