...
public class ClusterAdminOpsRequestHandler {
  ...
  public AdminTopicMetadataGrpcResponse updateAdminTopicMetadata(UpdateAdminTopicMetadataGrpcRequest request) {
    ...
    PositionGrpcWireFormat position = metadata.hasPosition() ? metadata.getPosition() : null;
    PositionGrpcWireFormat upstreamPosition = metadata.hasUpstreamPosition() ? metadata.getUpstreamPosition() : null;
    LOGGER.info(
