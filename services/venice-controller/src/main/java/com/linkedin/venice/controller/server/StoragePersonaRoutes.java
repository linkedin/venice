...
public class StoragePersonaRoutes extends AbstractRoute {
  ...
  public Route getStoragePersona(Admin admin) {
    return new VeniceParentControllerRegionStateHandler(
        admin,
        new VeniceRouteHandler<StoragePersonaResponse>(StoragePersonaResponse.class) {
          @Override
  ...
  public Route getClusterStoragePersonas(Admin admin) {
    return new VeniceParentControllerRegionStateHandler(
        admin,
        new VeniceRouteHandler<MultiStoragePersonaResponse>(MultiStoragePersonaResponse.class) {
          @Override
