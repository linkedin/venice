...
import static com.linkedin.venice.controllerapi.ControllerRoute.GET_HEARTBEAT_TIMESTAMP;
...
public class AdminSparkServer extends AbstractVeniceService {
  ...
  public boolean startInner() throws Exception {
    ...
    httpService.post(SEND_HEARTBEAT_TIMESTAMP.getPath(), storesRoutes.sendHeartbeatToSystemStore(admin));
    httpService.get(GET_HEARTBEAT_TIMESTAMP.getPath(), storesRoutes.getHeartbeatFromSystemStore(admin));
