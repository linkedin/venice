...
public class ClusterAdminOpsRequestHandlerTest {
  ...
  public void testGetAdminTopicMetadataSuccess() {
    ...
    PositionGrpcWireFormat positionGrpcWireFormat = PubSubUtil.getPositionGrpcWireFormat(position);
    PubSubPosition upstreamPosition = InMemoryPubSubPosition.of(789L);
    PositionGrpcWireFormat upstreamPositionGrpcWireFormat = PubSubUtil.getPositionGrpcWireFormat(upstreamPosition);
    ...
    assertEquals(adminTopicGrpcMetadata.getPosition(), positionGrpcWireFormat);
    assertEquals(adminTopicGrpcMetadata.getUpstreamPosition(), upstreamPositionGrpcWireFormat);
  ...
  public void testUpdateAdminTopicMetadataSuccess() {
    ...
    AdminTopicGrpcMetadata metadata = AdminTopicGrpcMetadata.newBuilder()
        ...
        .setPosition(PubSubUtil.getPositionGrpcWireFormat(InMemoryPubSubPosition.of(123L)))
        .setUpstreamPosition(PubSubUtil.getPositionGrpcWireFormat(InMemoryPubSubPosition.of(456L)))
        .build();
