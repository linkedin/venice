...
public class PartitionHealthOtelMetricEntityTest {
  private static Map<PartitionHealthOtelMetricEntity, MetricEntityExpectation> expectedDefinitions() {
  ...
  public void testMetricEntities() {
    new ModuleMetricEntityTestFixture<>(PartitionHealthOtelMetricEntity.class, expectedDefinitions()).assertAll();
  }
}
