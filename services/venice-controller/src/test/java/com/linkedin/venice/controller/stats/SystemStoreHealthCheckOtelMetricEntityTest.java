...
public class SystemStoreHealthCheckOtelMetricEntityTest {
  private static Map<SystemStoreHealthCheckOtelMetricEntity, MetricEntityExpectation> expectedDefinitions() {
  ...
  public void testMetricEntities() {
    new ModuleMetricEntityTestFixture<>(SystemStoreHealthCheckOtelMetricEntity.class, expectedDefinitions())
        .assertAll();
  }
}
