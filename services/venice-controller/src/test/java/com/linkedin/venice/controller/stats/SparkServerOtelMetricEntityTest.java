...
public class SparkServerOtelMetricEntityTest extends AbstractModuleMetricEntityTest<SparkServerOtelMetricEntity> {
  public SparkServerOtelMetricEntityTest() {
    super(SparkServerOtelMetricEntity.class);
  }

  @Override
  protected Map<SparkServerOtelMetricEntity, MetricEntityExpectation> expectedDefinitions() {
