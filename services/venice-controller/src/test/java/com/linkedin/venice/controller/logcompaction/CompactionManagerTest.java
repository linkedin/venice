...
public class CompactionManagerTest {
  ...
  private static final String TEST_CLUSTER_NAME_3 = "test-cluster-3";
  ...
  public void setUp() {
    ...
    Set<RepushCandidateTrigger> candidateTriggers =
        Collections.singleton(new VersionStalenessFilter(multiClusterConfig));
  ...
  public void testRepushStoreWithNullResponse() throws Exception {
    ...
    RepushJobRequest repushJobRequest = new RepushJobRequest(
        ...
        StoreRepushTriggerSource.MANUAL);
