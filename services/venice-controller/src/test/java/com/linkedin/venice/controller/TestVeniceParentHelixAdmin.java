...
public class TestVeniceParentHelixAdmin extends AbstractTestVeniceParentHelixAdmin {
  ...
  @Test
  public void testEnableActiveActiveSetsReplicationPolicy() {
    String storeName = Utils.getUniqueString("testUpdateStore");
    Store store = TestUtils.createTestStore(storeName, "test", System.currentTimeMillis());
    ...
    UpdateStore updateStore = (UpdateStore) adminMessage.payloadUnion;
    assertEquals(updateStore.activeActiveReplicationEnabled, true);
    assertEquals(updateStore.hybridStoreConfig.dataReplicationPolicy, DataReplicationPolicy.ACTIVE_ACTIVE.getValue());
  }
