...
public class ClusterDiscoveryTest {
  ...
  public void testDiscoverCluster() throws Exception {
    ...
    DiscoverClusterGrpcResponse discoverClusterGrpcResponse = DiscoverClusterGrpcResponse.newBuilder()
        .setClusterName(clusterName)
        .setStoreName(storeName)
        .setD2Service(d2Service)
        .setServerD2Service(serverD2Service)
        .build();
    doReturn(discoverClusterGrpcResponse).when(requestHandler).discoverCluster(any(DiscoverClusterGrpcRequest.class));
