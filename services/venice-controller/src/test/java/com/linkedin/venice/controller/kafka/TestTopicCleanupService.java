...
public class TestTopicCleanupService {
  ...
  public void testCleanupVeniceTopics() {
    ...
    doReturn(true).when(admin).canDeleteRTTopic(anyString(), anyString());
    ...
    doReturn(false).when(admin).canDeleteRTTopic(anyString(), eq(storeName1));
    doReturn(false).when(admin).canDeleteRTTopic(anyString(), eq(storeName2));
    doReturn(false).when(admin).canDeleteRTTopic(anyString(), eq(storeName3));
    doReturn(true).when(admin).canDeleteRTTopic(anyString(), eq(storeName4));
    doReturn(true).when(admin).canDeleteRTTopic(anyString(), eq(storeName6));
    ...
    doReturn(true).when(admin).canDeleteRTTopic(anyString(), eq(storeName2));
    doReturn(true).when(admin).canDeleteRTTopic(anyString(), eq(storeName3));
    topicCleanupService.cleanupVeniceTopics();
  ...
  public void testCleanVeniceTopicRTTopicDeletionWithErrorFetchingVT() {
    ...
    doReturn(storeTopics).when(topicManager).getAllTopicRetentions();
    doReturn(Pair.create("cluster0", null)).when(admin).discoverCluster(any());
    doReturn(false).when(admin).canDeleteRTTopic(anyString(), anyString());
    doReturn(Optional.of(new StoreConfig(storeName))).when(storeConfigRepository).getStoreConfig(storeName);
