...
public class DeferredVersionSwapTehutiMetricNameEnumTest
    extends AbstractTehutiMetricNameEnumTest<DeferredVersionSwapTehutiMetricNameEnum> {
  public DeferredVersionSwapTehutiMetricNameEnumTest() {
    super(DeferredVersionSwapTehutiMetricNameEnum.class);
  }

  @Override
  protected Map<DeferredVersionSwapTehutiMetricNameEnum, String> expectedMetricNames() {
