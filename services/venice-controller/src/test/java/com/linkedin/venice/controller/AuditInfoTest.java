...
public class AuditInfoTest {
  ...
  public void testSuccessStringReturnsExpectedFormat() {
    ...
    String expected =
        "[AUDIT] SUCCESS GET http://localhost/test {param1=value1, param2=value2} ClientIP: 127.0.0.1:8080";
    assertEquals(result, expected);
  }
  ...
  public void testFailureStringReturnsExpectedFormat() {
    ...
    String expected =
        "[AUDIT] FAILURE: Some error GET http://localhost/test {param1=value1, param2=value2} ClientIP: 127.0.0.1:8080";
    assertEquals(result, expected);
  }
  ...
  public void testFailureStringHandlesNullErrorMessage() {
    ...
    String expected =
        "[AUDIT] FAILURE:  GET http://localhost/test {param1=value1, param2=value2} ClientIP: 127.0.0.1:8080";
    assertEquals(result, expected);
  }
}
