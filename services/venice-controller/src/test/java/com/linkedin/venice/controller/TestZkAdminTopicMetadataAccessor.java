...
public class TestZkAdminTopicMetadataAccessor {
  ...
  AdminMetadata.PubSubPositionJsonWireFormat positionWf =
      AdminMetadata.PubSubPositionJsonWireFormat.fromWireFormat(position.getPositionWireFormat());
  ...
  public void testUpdateMetadataWhenMetadataIsEmpty() {
    ...
    metadataDelta.put(AdminTopicMetadataAccessor.POSITION_KEY, positionWf);
  ...
  public void testGetMetadata() {
    ...
    assertTrue(zkAdminTopicMetadataAccessor.getV2AdminMetadata(clusterName).toMap().isEmpty());
