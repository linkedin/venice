...
public class SystemStoreFreeMetadataTest {
  ...
  public void setUp() throws Exception {
    ...
    systemStoreFreeMetadata = new SystemStoreFreeMetadata(clientConfig);
  ...
  private void verifyMetadata(
    ...
    TestUtils.waitForNonDeterministicAssertion(30, TimeUnit.SECONDS, () -> {
      ...
      assertEquals(
          ...
          "Different number of ready to serve instances between router and Metadata.");
      for (String instance: routerReadyToServeView) {
        assertTrue(metadataView.contains(instance), "Instance: " + instance + " is missing from Metadata.");
      }
    });
  }
