  ...
  public void testGetOfflineStatusIncrementalPush() {
    ...
    TestUtils.waitForNonDeterministicCompletion(
        ...
        () -> cluster.getLeaderVeniceController()
            .getVeniceAdmin()
            .getOffLinePushStatus(cluster.getClusterName(), versionTopic1, Optional.of(incPushV1), null, false)
            .getExecutionStatus()
    ...
    TestUtils.waitForNonDeterministicCompletion(
        ...
        () -> cluster.getLeaderVeniceController()
            .getVeniceAdmin()
            .getOffLinePushStatus(cluster.getClusterName(), versionTopic2, Optional.of(incPushV1), null, false)
            .getExecutionStatus()
            .equals(ExecutionStatus.END_OF_INCREMENTAL_PUSH_RECEIVED));
    ...
    TestUtils.waitForNonDeterministicCompletion(
        ...
        () -> cluster.getLeaderVeniceController()
            .getVeniceAdmin()
            .getOffLinePushStatus(cluster.getClusterName(), versionTopic2, Optional.of(incPush2), null, false)
            .getExecutionStatus()
