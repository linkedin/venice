...
public class VeniceClusterCreateOptions {
  ...
  public static class Builder {
    ...
    private int numberOfControllers = VeniceClusterWrapperConstants.DEFAULT_NUMBER_OF_CONTROLLERS;
    private int numberOfServers = VeniceClusterWrapperConstants.DEFAULT_NUMBER_OF_SERVERS;
    private int numberOfRouters = VeniceClusterWrapperConstants.DEFAULT_NUMBER_OF_ROUTERS;
    ...
    private boolean sslToStorageNodes = VeniceClusterWrapperConstants.DEFAULT_SSL_TO_STORAGE_NODES;
    private boolean sslToKafka = VeniceClusterWrapperConstants.DEFAULT_SSL_TO_KAFKA;
