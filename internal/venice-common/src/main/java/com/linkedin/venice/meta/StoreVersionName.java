...
public class StoreVersionName {
  ...
  StoreVersionName(String storeVersionName, StoreName storeName) {
    ...
    this.storeVersionName = Objects.requireNonNull(storeVersionName);
  ...
  public boolean equals(Object o) {
    if (this == o) {
      ...
      return this.storeVersionName.equals(that.storeVersionName);
    }
    return false;
  }
  ...
  @Override
  public int hashCode() {
    return this.storeVersionName.hashCode();
  }
}
