...
public abstract class TopicManagerTestBase {
  private static final Logger LOGGER = LogManager.getLogger(TopicManagerTestBase.class);
  ...
  protected abstract void createTopicManager();

  protected abstract PubSubProducerAdapter createPubSubProducerAdapter();
