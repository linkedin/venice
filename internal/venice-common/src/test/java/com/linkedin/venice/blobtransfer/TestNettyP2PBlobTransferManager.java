...
public class TestNettyP2PBlobTransferManager {
  ...
  public void setUp() throws Exception {
    ...
    tmpSnapshotDir = Files.createTempDirectory("tmpSnapshotDir");
    tmpPartitionDir = Files.createTempDirectory("tmpPartitionDir");
  ...
  @Test
  public void testLocalFileTransfer() throws IOException, ExecutionException, InterruptedException {
    BlobPeersDiscoveryResponse response = new BlobPeersDiscoveryResponse();
