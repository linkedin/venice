...
import io.netty.handler.codec.EspressoMessageToMessageEncoder;
...
/**
 * Forked from Netty 4.1.42.Final. Main change is to extend EspressoMessageToMessageEncoder to avoid creating
 * {@link io.netty.util.internal.TypeParameterMatcher}.
 *
 ...
 */
public abstract class EspressoHttpObjectEncoder<H extends HttpMessage> extends EspressoMessageToMessageEncoder<Object> {
    ...
    if (msg instanceof HttpContent || msg instanceof ByteBuf || msg instanceof FileRegion) {
      switch (state) {
        ...
        case ST_CONTENT_NON_CHUNK:
          ...
          // fall-through!
        case ST_CONTENT_ALWAYS_EMPTY: // SUPPRESS CHECKSTYLE FallThroughCheck
