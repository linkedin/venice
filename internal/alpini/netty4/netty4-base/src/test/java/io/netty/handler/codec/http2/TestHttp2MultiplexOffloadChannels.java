...
/**
 * Tests for {@link EspressoHttp2MultiplexHandler} for reuseChildChannels - false, offloadChildChannels - true
 *
 * @author Abhishek Andhavarapu
 */
@Test(groups = "unit")
public class TestHttp2MultiplexOffloadChannels extends TestHttp2Multiplex<Http2FrameCodec> {
  ...
  protected EspressoHttp2MultiplexHandler newMultiplexer(TestChannelInitializer childChannelInitializer) {
    this.multiplexer = new EspressoHttp2MultiplexHandler(childChannelInitializer, false, true);
    return multiplexer;
  }
