...
/**
 * Tests for {@link EspressoHttp2MultiplexHandler} for reuseChildChannels - true, offloadChildChannels - true
 *
...
public class TestHttp2MultiplexReuseAndOffloadChannels extends TestHttp2Multiplex<Http2FrameCodec> {
  ...
  protected EspressoHttp2MultiplexHandler newMultiplexer(TestChannelInitializer childChannelInitializer) {
    this.multiplexer = new EspressoHttp2MultiplexHandler(childChannelInitializer, true, true);
    return multiplexer;
  }
