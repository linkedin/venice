...
/**
 * Forked from Netty. Used for unit tests
...
public final class Http2TestUtil {
  ...
  public static HpackEncoder newTestEncoder(
      ...
      long maxHeaderTableSize) throws Http2Exception {
  ...
  static class FrameAdapter extends ByteToMessageDecoder {
    ...
    FrameAdapter(
        ...
        DefaultHttp2FrameReader reader,
  ...
  static class FrameCountDown implements Http2FrameListener {
    ...
    FrameCountDown(
        Http2FrameListener listener,
        CountDownLatch settingsAckLatch,
        CountDownLatch messageLatch,
        CountDownLatch dataLatch,
        CountDownLatch trailersLatch) {
  ...
  static Http2FrameWriter mockedFrameWriter() {
    ...
    when(
        frameWriter.writeSettings(
            Mockito.any(ChannelHandlerContext.class),
            any(Http2Settings.class),
            any(ChannelPromise.class))).thenAnswer(new Answer<ChannelFuture>() {
              @Override
              public ChannelPromise answer(InvocationOnMock invocationOnMock) {
    ...
    when(frameWriter.writeSettingsAck(any(ChannelHandlerContext.class), any(ChannelPromise.class)))
        .thenAnswer(new Answer<ChannelFuture>() {
          @Override
          public ChannelPromise answer(InvocationOnMock invocationOnMock) {
            return ((ChannelPromise) invocationOnMock.getArguments()[1]).setSuccess();
          }
        });
    ...
    when(
        frameWriter.writeGoAway(
            ...
            any(ChannelPromise.class))).thenAnswer(new Answer<ChannelFuture>() {
              @Override
              public ChannelPromise answer(InvocationOnMock invocationOnMock) {
                buffers.offer((ByteBuf) invocationOnMock.getArguments()[3]);
    ...
    when(
        frameWriter.writeHeaders(
            ...
            any(ChannelPromise.class))).thenAnswer(new Answer<ChannelFuture>() {
              @Override
              public ChannelPromise answer(InvocationOnMock invocationOnMock) {
                return ((ChannelPromise) invocationOnMock.getArguments()[5]).setSuccess();
              }
            });
    ...
    when(
        frameWriter.writeData(
            ...
            any(ChannelPromise.class))).thenAnswer(new Answer<ChannelFuture>() {
              @Override
              public ChannelPromise answer(InvocationOnMock invocationOnMock) {
                buffers.offer((ByteBuf) invocationOnMock.getArguments()[2]);
                return ((ChannelPromise) invocationOnMock.getArguments()[5]).setSuccess();
              }
            });

    when(frameWriter.writeRstStream(any(ChannelHandlerContext.class), anyInt(), anyLong(), any(ChannelPromise.class)))
        .thenAnswer(new Answer<ChannelFuture>() {
          @Override
          public ChannelPromise answer(InvocationOnMock invocationOnMock) {
            return ((ChannelPromise) invocationOnMock.getArguments()[3]).setSuccess();
          }
        });

    when(frameWriter.writeWindowUpdate(any(ChannelHandlerContext.class), anyInt(), anyInt(), any(ChannelPromise.class)))
    ...
    when(
        frameWriter.writePushPromise(
            any(ChannelHandlerContext.class),
            anyInt(),
            anyInt(),
            any(Http2Headers.class),
            anyInt(),
            anyChannelPromise())).thenAnswer(new Answer<ChannelFuture>() {
              @Override
              public ChannelPromise answer(InvocationOnMock invocationOnMock) {
                return ((ChannelPromise) invocationOnMock.getArguments()[5]).setSuccess();
              }
    ...
    when(
        frameWriter.writeFrame(
            ...
            anyChannelPromise())).thenAnswer(new Answer<ChannelFuture>() {
              @Override
              public ChannelPromise answer(InvocationOnMock invocationOnMock) {
                buffers.offer((ByteBuf) invocationOnMock.getArguments()[4]);
                return ((ChannelPromise) invocationOnMock.getArguments()[5]).setSuccess();
              }
            });
    return frameWriter;
