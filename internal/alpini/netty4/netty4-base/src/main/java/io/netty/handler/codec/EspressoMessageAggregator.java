 ...
 *
 * An abstract {@link io.netty.channel.ChannelHandler} that aggregates a series of message objects into a single aggregated message.
 * <p>
 ...
 */
public abstract class EspressoMessageAggregator<I, S, C extends ByteBufHolder, O extends ByteBufHolder>
  ...
  protected EspressoMessageAggregator(int maxContentLength, Class<? extends I> inboundMessageType) {
  ...
  protected void decode(final ChannelHandlerContext ctx, I msg, List<Object> out) throws Exception {
    ...
    if (isStartMessage(msg)) {
      ...
      if (continueResponse != null) {
        ...
        if (listener == null) {
          continueResponseWriteListener = listener = new ChannelFutureListener() { // SUPPRESS CHECKSTYLE
                                                                                   // InnerAssignment
            @Override
