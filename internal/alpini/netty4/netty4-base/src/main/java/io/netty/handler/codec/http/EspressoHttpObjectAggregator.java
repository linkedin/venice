...
import io.netty.handler.codec.EspressoMessageAggregator;
...
/**
 * Forked from Netty 4.1.42.Final. Main change is to extend EspressoMessageAggregator to avoid creating
...
public class EspressoHttpObjectAggregator
    extends EspressoMessageAggregator<HttpObject, HttpMessage, HttpContent, FullHttpMessage> {
  ...
  private static final FullHttpResponse EXPECTATION_FAILED =
      new DefaultFullHttpResponse(HttpVersion.HTTP_1_1, HttpResponseStatus.EXPECTATION_FAILED, Unpooled.EMPTY_BUFFER);
