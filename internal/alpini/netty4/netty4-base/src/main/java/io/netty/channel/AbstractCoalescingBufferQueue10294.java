 ...
 *
 * Includes fix to guard readableBytes from re-entry. https://github.com/netty/netty/pull/10294
 *
...
public abstract class AbstractCoalescingBufferQueue10294 {
  private static final InternalLogger logger =
      InternalLoggerFactory.getInstance(AbstractCoalescingBufferQueue10294.class);
   ...
   */
  protected AbstractCoalescingBufferQueue10294(Channel channel, int initSize) {
