...
AVRO_SCHEMAS_PATH=(
  "venice-common/src/main/resources/avro/KafkaMessageEnvelope/v5/*"
  "venice-common/src/main/resources/avro/PartitionState/v4/*"
  ...
  "venice-controller/src/main/resources/avro/AdminOperation/v16/*"
