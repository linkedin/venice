...
AVRO_SCHEMAS_PATH=(
  ...
  "venice-common/src/main/resources/avro/PartitionState/v9/*"
  ...
  "venice-controller/src/main/resources/avro/AdminOperation/v51/*"
  ...
  "venice-common/src/main/resources/avro/StoreMeta/StoreMetaValue/v2/*"
